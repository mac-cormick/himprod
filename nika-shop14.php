				...
				<div class="box1">
					<div class="col_1_of_single1 span_1_of_single1"><a href="register.php">
						<div class="view1 view-fifth1">
							<div class="top_box">
								<h3 class="m_1">«Ника-4»</h3>
								<p class="m_2">Средство моющее техническое 1 кг и 5кг</p>
								<div class="grid_img">
									<div class="css3"><img src="images/products/nika-shop14/1.png" alt=""/></div>
									<div class="mask1">
					...
					<!-- <div class="col_1_of_single1 span_1_of_single1"><a href="register.php">
						<div class="view1 view-fifth1">
							<div class="top_box">
								<h3 class="m_1">«Ника-4»</h3>
								<p class="m_2">Средство моющее техническое 5 кг</p>
								<div class="grid_img">
									<div class="css3"><img src="images/products/nika-shop14/2.png" alt=""/></div>
									<div class="mask1">
										<div class="info"><a href="register.php">ЗАКАЗАТЬ</a></div>
									</div>
								</div>
