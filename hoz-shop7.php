	...
	<div class="login">
		<div class="wrap">
			...
			<div class="cont span_2_of_3 prod-items">
				<h2>Комплекты для туалета</h2>
				<div class="box1">
					<div class="col_1_of_single1 span_1_of_single1"><a href="register.php">
						<div class="view1 view-fifth1">
							<div class="top_box">
								<h3 class="m_1">ЕРШ ДЛЯ ТУАЛЕТА</h3>
								<p class="m_2">Ерш туалетный Стандарт V=0,05</p>
								<div class="grid_img">
									<div class="css3"><img src="images/products/hoz-shop7/1.jpg" alt=""/></div>
									<div class="mask1">
					...
					<div class="col_1_of_single1 span_1_of_single1"><a href="register.php">
						<div class="view1 view-fifth1">
							<div class="top_box">
								<h3 class="m_1">ЕРШ ДЛЯ ТУАЛЕТА</h3>
								<p class="m_2">Ершик туалетный без подставки</p>
								<div class="grid_img">
									<div class="css3"><img src="images/products/hoz-shop7/2.jpg" alt=""/></div>
									<div class="mask1">
										<div class="info"><a href="register.php">ЗАКАЗАТЬ</a></div>
									</div>
								</div>
