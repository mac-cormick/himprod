				...
				<div class="box1">
					<div class="col_1_of_single1 span_1_of_single1"><a href="register.php">
						<div class="view1 view-fifth1">
							<div class="top_box">
								<h3 class="m_1">«Ника-Стеклоочиститель»</h3>
								<p class="m_2">Средство чистящее с пенооброзователем, с триггером 0,75кг и 5 кг ПЭТ</p>
								<div class="grid_img">
									<div class="css3"><img src="images/products/nika-shop8/1.png" alt=""/></div>
									<div class="mask1">
					...
					<!-- <div class="col_1_of_single1 span_1_of_single1"><a href="register.php">
						<div class="view1 view-fifth1">
							<div class="top_box">
								<h3 class="m_1">«Ника-Стеклоочиститель»</h3>
								<p class="m_2">Средство чистящее  5 л</p>
								<div class="grid_img">
									<div class="css3"><img src="images/products/nika-shop8/2.png" alt=""/></div>
									<div class="mask1">
										<div class="info"><a href="register.php">ЗАКАЗАТЬ</a></div>
									</div>
								</div>
