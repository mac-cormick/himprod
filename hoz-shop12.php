				...
				<div class="box1">
					<div class="col_1_of_single1 span_1_of_single1"><a href="register.php">
						<div class="view1 view-fifth1">
							<div class="top_box">
								<h3 class="m_1">ПАКЕТ ФАСОВОЧНЫЙ</h3>
								<p class="m_2">Пакет фасовочный 8 на 38 Евро Солнышко и 24 на 37  Экстра+</p>
								<div class="grid_img">
									<div class="css3"><img src="images/products/hoz-shop12/1.jpg" alt=""/></div>
									<div class="mask1">
